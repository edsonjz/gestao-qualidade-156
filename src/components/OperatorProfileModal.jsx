                      ...
                      history.slice().reverse().map(h => (
                        <tr key={h.id} className="hover:bg-zinc-50 dark:hover:bg-zinc-900/30 transition-colors">
                          ...
                          <td 
                            ...
                            className="px-4 py-2.5 leading-relaxed max-w-sm truncate text-zinc-500 dark:text-zinc-400 hover:text-blue-600 dark:hover:text-blue-400 cursor-pointer font-medium border-zinc-100 dark:border-zinc-800" 
                          ...
                          <td className="px-4 py-2.5 text-center whitespace-nowrap no-print flex items-center justify-center gap-2">
                            <button
                              onClick={() => setSelectedMonitoringForDetails(h)}
                              className="inline-flex items-center gap-1 px-2 py-1 bg-zinc-100 hover:bg-zinc-200 dark:bg-zinc-800 dark:hover:bg-zinc-700 text-zinc-800 dark:text-zinc-200 rounded font-bold transition-all cursor-pointer text-[10px]"
