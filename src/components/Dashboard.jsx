...
export default function Dashboard({ 
  ...
  }, [operators, monitorings, effectiveMonitorings, monitors, activeCycle]);
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="bg-white dark:bg-[#0c0c0f] p-5 rounded-2xl border border-zinc-200 dark:border-zinc-800 shadow-sm flex items-center justify-between">
          <div className="space-y-1.5">
            ...
            <div className="flex items-baseline gap-2">
              ...
              <span className="text-xs text-zinc-400">meta geral: {kpis.metaDia}</span>
            </div>
            <div className="mt-1">
        ...
        <div className="bg-white dark:bg-[#0c0c0f] p-5 rounded-2xl border border-zinc-200 dark:border-zinc-800 shadow-sm flex items-center justify-between">
          <div className="space-y-1.5">
            ...
            <div className="flex items-baseline gap-2">
              ...
              <span className="text-xs text-amber-600 dark:text-amber-400 font-medium">bloqueando operador</span>
            </div>
          </div>
      ...
      {/* 2. DESTAQUE: MONITORIAS REALIZADAS HOJE POR MONITORA */}
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-zinc-100 dark:border-zinc-800/80 pb-4">
          <div>
            <h3 className="text-sm font-bold text-zinc-900 dark:text-zinc-100 uppercase tracking-wider flex items-center gap-2">
              ...
              Monitorias Realizadas Hoje (
              {new Date().toLocaleDateString('pt-BR', { weekday: 'long', day: '2-digit', month: 'long' })})
            </h3>
            <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-0.5">
              Acompanhamento em tempo real da produtividade diária por monitor(a) avaliador(a)
            </p>
          </div>
          <div className="flex items-center gap-2 self-start sm:self-auto">
            <span className="text-xs font-bold px-3 py-1 bg-blue-50 text-blue-700 dark:bg-blue-950/40 dark:text-blue-300 rounded-full border border-blue-200/50 dark:border-blue-900/40">
              Total Hoje: {kpis.monitoringsToday} avaliações
            </span>
          </div>
        </div>
      ...
      {/* 3. RANKING DE MONITORIAS POR MONITORA (COM FILTRO DIA / SEMANA / MÊS & METAS) */}
      <div className="bg-white dark:bg-[#0c0c0f] rounded-2xl border border-zinc-200 dark:border-zinc-800 p-6 shadow-sm space-y-5">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-zinc-100 dark:border-zinc-800/80 pb-4">
          ...
          <div className="flex items-center bg-zinc-100 dark:bg-zinc-900 p-1 rounded-xl border border-zinc-200 dark:border-zinc-800 text-xs font-bold">
            ...
            <button
              onClick={() => setMonitorPeriod('month')}
              className={`px-3.5 py-1.5 rounded-lg transition-all cursor-pointer ${
                monitorPeriod === 'month'
                  ? 'bg-white dark:bg-zinc-800 text-blue-600 dark:text-blue-400 shadow-sm font-extrabold'
                  : 'text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-100'
        ...
        {/* Tabela do Ranking de Monitores */}
